...
// BUILD-MARKER: v3-bncc-fix-2026-07-19b — si ves este comentario en el archivo
...
// A esta escala (miles de platillos) leerlo de archivo es instantáneo y sin
// límite de rate; Airtable se queda solo para datos transaccionales (pacientes,
// consultas). El archivo debe vivir en api/data/bncc-data.json para que Vercel
// lo incluya en el bundle de la función.
//
// NOTA TÉCNICA: __dirname aquí es el global nativo de CommonJS — Vercel carga
// este archivo así aunque tenga sintaxis de import/export, así que NUNCA usar
// import.meta.url/fileURLToPath (revienta la función completa con
// "Cannot use 'import.meta' outside a module").
let BNCC_DATA = { ingredientes: [], platillos: [] };
try {
  BNCC_DATA = JSON.parse(fs.readFileSync(path.join(__dirname, 'data', 'bncc-data.json'), 'utf-8'));
} catch (err) {
