...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Antes esto se devolvía tal cual y, si content[0] no era un bloque de
    // texto (o venía vacío), el cliente mostraba "Sin respuesta de NOVA."
    // sin ninguna pista de qué pasó. Ahora lo validamos aquí y, si falla,
    // regresamos un error explícito con contexto en los logs de Vercel.
