// Cobertura de compararNombres() (api/nova.js) — traída de la rama
// fix/nova-idioma-y-consentimiento (commit ecef53a) como dependencia del
// dedup de registrar_lead. Sin dependencias: runner nativo de Node.
// Correr con: node --test
//
// compararNombres(registrado, documento) tolera acentos, mayúsculas, orden de
// tokens y abreviaturas ("Otero B., Abel"); NO usa similitud difusa. Umbral:
// 2 tokens significativos en común (un solo apellido no alcanza). No
// distingue homónimos — eso lo hace el código/identificador, no el nombre.
...
test('coincide: abreviatura "Otero B., Abel"', () => {
...
test('coincide: homónimos — dos "Diana Samano" coinciden por nombre (los distingue el identificador)', () => {
